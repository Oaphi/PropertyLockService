...
var PropertyLock_ = () => {
    ...
    const toSleep = 10 /* SLEEP */;
    const currentGSuiteRuntimeLimit = 1800000 /* MAX_RUNTIME */;
    let locked = false;
    let timeout = 0;
    const Lock = Object.freeze({
        ...
        releaseLock() {
            try {
                ...
                const trigger = ScriptApp.getProjectTriggers().find((n) => n.getHandlerFunction() === triggerName);
